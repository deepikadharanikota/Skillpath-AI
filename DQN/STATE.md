...
- **`docker-compose.yml`**:
  - **Frontend URL Routing**: Added `FRONTEND_URL=http://localhost:8501` to the backend container's environment variables to configure explicit redirects back to Streamlit.
